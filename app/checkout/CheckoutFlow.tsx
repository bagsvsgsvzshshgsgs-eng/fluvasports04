  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12 xl:gap-x-20 items-start">
      ...
      <div className="lg:col-span-7 xl:col-span-7">
        <div className="mb-10">
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              defaultChecked
            />
            <span className="text-sm text-gray-300">Email me with news and offers</span>
          </label>
        </div>

        <div className="mb-10">
          <h2 className="text-lg font-medium text-white mb-6">Shipping Address</h2>
          <div className="grid grid-cols-2 gap-4 mb-4">
            <input
              ...
              className="w-full border border-gray-800 px-4 py-3.5 text-sm focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
            />
            <input
              type="text"
          ...
          <input
            type="text"
            placeholder="Address"
            className="w-full border border-gray-800 px-4 py-3.5 text-sm focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 mb-4"
          />
          <input
            type="text"
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            <input
              type="text"
              placeholder="City"
              className="col-span-3 sm:col-span-1 border border-gray-800 px-4 py-3.5 text-sm focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
            />
            <select className="col-span-3 sm:col-span-1 border border-gray-800 px-4 py-3.5 text-sm focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 bg-transparent appearance-none">
        ...
        <div className="mb-10">
          <h2 className="text-lg font-medium text-white mb-6">Payment</h2>
      ...
      <div className="mt-12 lg:mt-0 lg:col-span-5 xl:col-span-5 border border-gray-800 bg-gray-900 p-6 md:p-8 sticky top-24">
        ...
        <div className="flex flex-col gap-6 mb-8 border-b border-gray-800 pb-8">
          ...
          <div className="flex gap-3 mt-2">
            <input
              ...
              className="flex-1 bg-black border border-gray-800 px-4 py-3 text-sm focus:outline-none focus:border-orange-500"
            />
        ...
        <div className="space-y-3 text-sm mb-6 pb-6 border-b border-gray-800">
          ...
          <div className="flex justify-between items-center text-gray-300">
            <span>Shipping</span>
            <span className="uppercase text-gray-500 text-xs tracking-wider">
